...
return(  <motion.div
  ...
  className={`relative ${active === id ? 'lg:flex-[3.5] flex-[10]' : 'lg:flex-[0.5] flex-[2]'}
   flex items-center
   justify-center min-w-[170px] h-[700px] transition-[flex] duration-[0.7s]
   ...
   <img src={imgUrl}
      ...
      onDoubleClick={()=>(router.push(`${Link}`))}/>
      {
        active!==id ? (
          ...
          sm:text-[26px] text-[18px] text-white absolute z-0
          ...
          rounded-b-[24px]">
            <div className={`${styles.flexCenter} w-[60px] h-[60px] rounded-[24px] mb-[16px] `}>
              <img src="/Hanger.png" alt="headset"
              className="w-1/2 h-1/2 object-contain" />
            </div>
            <p 
            className="font-normal text-[16px] leading-[20px]
             text-white uppercase"> Zangler </p>
             <h1  className="mt-[24px] font-semibold sm:text-[32px]
